...
public class Entity {
    ...
    public void attack(Entity entity){
        int diff = GameServer.getInstance().getConfig().getDifficulty();
        if (entity instanceof EntityPlayer){
            entity.setHealth((int) (entity.getHealth() - getAttackDamage() + 0.5 * diff));
            ...
            entity.setHealth((int) (entity.getHealth() - getAttackDamage() + 0.5 * diff));
            if(this instanceof EntityPlayer) System.out.println(((EntityPlayer) this).nickname + ANSI_RED +  " attacked " + ANSI_RESET + entity.title + " for " + this.getAttackDamage() + " dmg.");
            else System.out.println(this.title + ANSI_RED +  " attacked " + ANSI_RESET + entity.title + " for " + this.getAttackDamage() + " dmg.");
            }
            if (entity.getHealth() <= 0){
                if(this instanceof EntityPlayer) System.out.println(entity.getTitle() + " Was slain by " + ((EntityPlayer) this).getNickname());
                else System.out.println(entity.getTitle() + " Was slain by " + this.getTitle());
                this.target = null;
            }
        }
